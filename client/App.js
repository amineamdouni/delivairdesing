...
export default function App() {
  // const socket = socketIO.connect("http://192.168.167.101:3000");
    ...
    if (user) {
      ...
      for (let i = 0; i < user.contactList.length; i++) {
        axios
          ...
          .get(`http://192.168.167.101:5001/users/${user.contactList[i]}`)
      ...
      for (let i = 0; i < user.pendingRequests.length; i++) {
        axios
          ...
          .get(`http://192.168.167.101:5001/users/${user.pendingRequests[i]}`)
