...
export default function App() {
  ...
  //   if (user) {
  //     axios
  //       .get(`http://192.168.1.107:5001/users/id/${user.user_id}`)
  //       .then((res) => {
  //         setUser(res.data);
  //       });
  //   }
  ...
  //         .get(`http://192.168.1.107:5001/users/${user.contactList[i]}`)
  ...
  //         .get(`http://192.168.1.107:5001/users/${user.pendingRequests[i]}`)
