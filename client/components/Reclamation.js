      ...
      <View style={styles.formContainer}>
        ...
        <Formik
          ...
          onSubmit={(values) => {
            ...
            console.log(
              `Name: ${values.name} Email: ${values.email} Reclamation: ${values.reclamation}`
            );
          }}
        >
          {({
            ...
            <View style={styles.formFieldsContainer}>
              <Image
                source={{
                  uri: "https://tse3.mm.bing.net/th?id=OIP.GBfJtHNV9InrMI8pV5OGYgHaHa&pid=Api&P=0",
